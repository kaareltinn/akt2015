...
public class FiniteAutomatonTest {
    ...
    public void nfaKoosTsükliga3() {
        ...
        FiniteAutomaton fa = new FiniteAutomaton();
        fa.addState(17, false);
        fa.addState(11, false);
        fa.addState(6, false);
        fa.addState(4, false);
        fa.addState(24, false);
        fa.addState(2, false);
        fa.addState(21, false);
        fa.addState(8, false);
        fa.addState(12, false);
        fa.addState(3, false);
        fa.addState(18, false);
        fa.addState(9, false);
        fa.addState(1, true);
        fa.addState(23, false);
        fa.addState(20, false);
        fa.addState(7, false);
        fa.addState(22, false);
        fa.addState(19, false);
        fa.addState(10, false);
        fa.addState(14, false);
        fa.addState(13, false);
        fa.addState(16, false);
        fa.addState(5, false);
        fa.addState(0, false);
        fa.addState(15, false);
        fa.setStartState(0);
